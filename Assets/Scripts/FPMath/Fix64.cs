...
namespace FixMath
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        public static readonly Fix64 Rad2Deg = new Fix64(180.0f) / Pi;
        public static readonly Fix64 Deg2Rad = Pi / new Fix64(180.0f);
        ...
        public static Fix64 Acos(Fix64 x)
        {
            if (x < -One || x > One)
            {
                throw new ArgumentOutOfRangeException("Fix64");
            }
